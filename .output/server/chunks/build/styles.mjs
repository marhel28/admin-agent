...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.BjCNm5Sz.mjs').then(interopDefault),
  "pages/index.vue": () => import('./index-styles.iNe2YQ9m.mjs').then(interopDefault),
  "components/MiniMap.vue": () => import('./MiniMap-styles.BYmHCr9q.mjs').then(interopDefault),
